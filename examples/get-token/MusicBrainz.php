...
$musicbrainz = (new MusicBrainz($http, $options, $logger))->setStorage($storage);
...
elseif(isset($_GET['granted']) && $_GET['granted'] === $servicename){
	echo '<pre>'.print_r(MessageUtil::decodeJSON($musicbrainz->request(sprintf('/artist/%s', '573510d6-bb5d-4d07-b0aa-ea6afe39e28d'), ['inc' => 'url-rels work-rels'])), true).'</pre>';
