...
use chillerlan\OAuth\Providers\GuildWars2\GuildWars2Endpoints;

/** @var \Psr\Log\LoggerInterface $logger */
$logger = null;

require_once __DIR__.'/gw2-common.php';
...
$reflection = new \ReflectionClass(GuildWars2Endpoints::class);
