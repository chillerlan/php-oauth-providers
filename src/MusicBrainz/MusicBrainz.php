 ...
 * @method \Psr\Http\Message\ResponseInterface collectionAdd(string $collectionID, string $releaseIDs, array $params = ['client'])
 * @method \Psr\Http\Message\ResponseInterface collectionId(string $id)
 * @method \Psr\Http\Message\ResponseInterface collectionRemove(string $collectionID, string $releaseIDs, array $params = ['client'])
 ...
 * @method \Psr\Http\Message\ResponseInterface ratingSubmit(array $params = ['client'])
 ...
 * @method \Psr\Http\Message\ResponseInterface tagVote(array $params = ['client'])
